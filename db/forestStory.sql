...
(
 ...
 (
    'Forest Encounter',
    1,
    'Engage on a journey of survival throughout the kingdom.',
    1,
    now()
);
...
-- -------------------------------------------
UPDATE stories 
SET start_encounter_id = ForestEncounterID 
...
(
    ...
    '',
    WolvesEncounterID, --wolves encount
    ForestEncounterID, --forest encounter
    1,
    0
),
(
    ...
    '',
    BanditsEncounterID, --road encounter
    ForestEncounterID, --forest encounter
    1,
    0
);
...
(
    ...
    ThreePathsEncounterID,  --ThreePaths encounter
    DeathEncounterID, --death encounter
    1,
    0
),
(
...
(
    ...
    HideoutEncounterID, --hideout encounter
    DeathEncounterID, --death encounter
    1,
    0
),
(
    ...
    HideoutEncounterID, --hideout encounter
    ForestEncounterID, --death encounter
    1,
    0
),
(
...
(
    ...
    HideoutEncounterID, --TwoRoads encounter
    HideoutEncounterID, --TwoRoads encounter
    1,
    0
),
(
    ...
    '',
    '',
    TwoRoadsEncounterID, --TwoRoads encounter
    TwoRoadsEncounterID, --TwoRoads encounter
    1,
    0
),
...
-- leading off to the right up onto a mountain.
    ...
    '',
    ThreePathsEncounterID, --TwoRoads encounter
    ThreePathsEncounterID, --TwoRoads encounter
    1,
    0
),
...
(
    ...
    '',
    ThreePathsEncounterID, --Cave encounter
    ThreePathsEncounterID, --Cave encounter
    1,
    0
),
(
    ...
    CaveEncounterID, --Cave encounter
    DeathEncounterID, --Cave encounter
    1,
    0
);
...
(
    ...
    '',
    ShopEncounterID, --shopEncounterID
    ShopEncounterID, --shop encounter ID
    1,
    0
),
(
    ...
    '',
    CastleEncounterID, --CastleEncounterID
    CastleEncounterID, --CastleEncounterID
    1,
    0
);
...
values
(
    WagonEncounterID, -- wagon encounter
    ...
    CastleEncounterID, --Castle encounter
    DeathEncounterID, --Death encounter
    1,
    0
),
...
(
    ...
    CastleEncounterID, --Castle EncounterID
    ShopEncounterID, --shop encounter ID
    1,
    0
),
...
(
    ...
    FinishedEncounterID, --Castle EncounterID
    DeathEncounterID, --shop encounter ID
    1,
    0
),
(
    ...
    FinishedEncounterID, --CastleEncounterID
    DeathEncounterID, --ShopEncounterID
    1,
    0
),
(
