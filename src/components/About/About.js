			...
			<div className="page">
				...
				<div className="block-card-inner">
					...
					<div className="mobile-pad">
						...
						<p className="white">No journey encounter will be quite the same with our 'Battle Roll' which will roll a 1d6 die and check the result against the condition for success of each encounter.
					</p>
				...
				<div className="tech-used-container">
					<div className="block-card">
						...
						<h1 className="sub-title">Tech Used</h1>
						<div className="block-card-inner">
				...
				<div className="meet-team block-card">
