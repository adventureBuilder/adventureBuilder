    ...
    render() {
        ...
        const characterList = this.props.characters.filter(char => char.alive).map((character, i) =>
            <div className="tavern-char-container" key={i}>
                ...
                <div>{(this.state.characterIdModuleToShow === character.character_id) ? <CharacterDisplay character={character} slideVisible={this.state.slideVisible} openSlide={this.openSlide}/> : ''}
